    ...
    def verify(self, question: str, answer: str) -> dict:
        try:
            prompt = (
                ...
                "Step 3: Reply in EXACTLY this format on three new lines at the end:\n"
                "CORRECT: true or false\n"
                "CONFIDENCE: a decimal like 0.45 or 0.91\n"
                "REASON: one sentence\n"
            )
            ...
            # Parse last occurrence of each key
            # (model shows working first, verdict at the end)
            lines = {}
